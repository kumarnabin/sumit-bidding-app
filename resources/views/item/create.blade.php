                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('items.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="text" value="{{old('name')}}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea id="description"
                                              ...
                                              required autocomplete="current-description">{{old('description')}}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="number" min="0" step="0.01" value="{{old('price')}}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="bidding_start" type="date" value="{{old('bidding_start')}}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="bidding_end" type="date" value="{{old('bidding_end')}}"
